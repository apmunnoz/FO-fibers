...
def solveExact():
    ...
    PDE_solver_exact = LinearVariationalSolver(PDE_problem, solver_parameters=parsol_pde, nullspace=nullspace)
...
def solveImplicit():
    ...
    PDE_solver = NonlinearVariationalSolver(PDE_problem_imp, solver_parameters=params, nullspace=nullspace)
